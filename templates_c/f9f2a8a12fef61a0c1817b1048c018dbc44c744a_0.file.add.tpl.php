<?php
/* Smarty version 3.1.30, created on 2018-01-24 17:44:42
  from "/var/www/html/wordy/templates/word/add.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a68477a33c481_60599139',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f9f2a8a12fef61a0c1817b1048c018dbc44c744a' => 
    array (
      0 => '/var/www/html/wordy/templates/word/add.tpl',
      1 => 1516783481,
      2 => 'file',
    ),
  ),
...
function content_5a68477a33c481_60599139 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ja">
	<head>
...
?>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control"　type="text" id="word" name="word" placeholder="英語で入力" autocomplete="off" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['word']->value->getWord())===null||$tmp==='' ? '' : $tmp);?>
">
                </div>
                <div class="form-group">
                  <label for="inputRead">読み方その1&nbsp;<font color="red">必須</font></label>
                  <input class="form-control" type="text" id="read_1" name="read_1" placeholder="カタカナで入力" autocomplete="off" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['word']->value->getRead1())===null||$tmp==='' ? '' : $tmp);?>
">
                </div>
                <div class="form-group">
                  <label for="inputRead">読み方その2&nbsp;<font color="red">必須</font></label>
                  <input class="form-control" type="text" id="read_2" name="read_2" placeholder="カタカナで入力" autocomplete="off" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['word']->value->getRead1())===null||$tmp==='' ? '' : $tmp);?>
">
                </div>
                <div class="form-group">
                  <label for="inputRead">読み方その3</label>
                  <input class="form-control" type="text" id="read_3" name="read_3" placeholder="カタカナで入力" autocomplete="off" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['word']->value->getRead3())===null||$tmp==='' ? '' : $tmp);?>
">
                </div>
                <div class="form-group">
                  <label for="inputRead">読み方その4</label>
                  <input class="form-control" type="text" id="read_4" name="read_4" placeholder="カタカナで入力" autocomplete="off" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['word']->value->getRead4())===null||$tmp==='' ? '' : $tmp);?>
">
                </div>
